...
using Geta.SocialChannels.Sample.Models.Blocks;
...
namespace Geta.SocialChannels.Sample.Models.Pages
{
    ...
    [AvailableContentTypes(
        ...
        Include = new[] { typeof(ContainerPage), typeof(ProductPage), typeof(StandardPage), typeof(ISearchPage), typeof(LandingPage), typeof(ContentFolder), typeof(GetaSocialChannelsPage) }, // Pages we can create under the start page...
